...
class Query_card:
    ##Structure to keep information about playing cards in the camera image.##
...
class Train_ranks:
    ...
    def __init__(self):
        self.img = [] # Thresholded, sized rank image loaded from computer
...
class Train_suits:
    ...
    def __init__(self):
        self.img = [] # Thresholded, sized suit image loaded from computer
        self.name = "Placeholder"

def load_ranks(filepath):
    ##Loads rank images from computer and stores them in a list of Train_ranks objects.##
...
def load_suits(filepath):
    ##Loads suit images from computer and stores them in a list of Train_suits objects.##
...
def flattener(image, pts, w, h):
    ...
    # Calculate perspective transform matrix,and warp card image #
